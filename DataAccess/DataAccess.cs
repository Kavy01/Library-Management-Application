    ...
    public class DataAccess : IDataAccess
    {
        ...
        public int CreateUser(User user)
        {
            ...
            using (var connection = new SqlConnection(DbConnection))
            {
                ...
                var sql = "insert into Users (FirstName, LastName, Email, Mobile, Password, Blocked, Active, Fine, CreatedOn, UserType) values (@fn, @ln, @em, @mb, @pwd, @blk, @act, @fine, @con, @type);";
        ...
        public bool OrderBook(int userId, int bookId)
        {
            ...
            using (var connection = new SqlConnection(DbConnection))
            {
                var sql = $"insert into Orders (UserId, BookId, OrderDate, Returned) values ({userId}, {bookId}, '{DateTime.Now:yyyy-MM-dd HH:mm:ss}', 0);";
            ...
            using (var connection = new SqlConnection(DbConnection))
            {
                var sql = @"
                    select 
                        ...
                        o.OrderDate as OrderDate, o.Returned as Returned
        ...
        public IList<User> GetUsers()
        {
            ...
            using (var connection = new SqlConnection(DbConnection))
            {
                ...
                var listOfOrders =
                    connection.Query("select u.Id as UserId, o.BookId as BookId, o.OrderDate as OrderDate, o.Returned as Returned from Users u LEFT JOIN Orders o ON u.Id=o.UserId;");
